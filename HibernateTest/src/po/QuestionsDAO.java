...
public class QuestionsDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(QuestionsDAO.class);
	// property constants
	...
	public Questions findById(java.lang.Integer id) {
		...
		try {
			Questions instance = (Questions) getSession().get("po.Questions",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Questions instance) {
		...
		try {
			List results = getSession().createCriteria("po.Questions").add(
