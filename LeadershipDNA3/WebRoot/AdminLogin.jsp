  ...
  <body >
    ...
    <div  class="container" style="height:768px;width:1366px;padding-top: 0px;background-color: white;float: none;">
    	<div style="text-align: center;">
      	 ...
      	 <form id="form1" class="form-signin" action="./AdminCheckLogin" method="post">
        	<h2 class="form-signin-heading" style="text-align: center;">Administrator</h2>
        	<input id="a" name="username" type="text" class="input-block-level" placeholder="Administrator" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" >
